...
-- 2024. รกpr. 16., kedd, 14:51:24 CEST
...
CREATE TABLE IF NOT EXISTS `groups` (
  ...
  `state` VARCHAR(32) NOT NULL DEFAULT 'member' COMMENT 'active | closed | paused | Proposal',
...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `state` VARCHAR(32) NOT NULL DEFAULT 'draft' COMMENT 'active | aspirant | closed | disabled | paused | draft',
