...
include_once __DIR__.'/db_dat_file/where.php';
include_once __DIR__.'/db_dat_file/collection.php';
...
class Query extends \Where {
    ...
    public function insert($record): int {
        return $this->source->insert($record);
    }    
    ...
    public function update($record) {
        ...
        foreach ($olds as $old) {
            $record->id = $old->id;
            $this->source->updateById($old->id, $record);
        } 
    }
