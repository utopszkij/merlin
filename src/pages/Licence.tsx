...
const Licence = () => {
	return (
		...
		<div id="licensz">
				<div id="content">
				<p>
				<strong>This is an unofficial translation of the GNU General Public License into Hungarian. It was not published by the Free Software Foundation, and does not legally state the distribution terms for software that uses the GNU GPL—only the original English text of the GNU GPL does that. However, we hope that this translation will help Hungarian speakers understand the GNU GPL better.</strong>
				</p>
				<p><strong>Ez a GNU General Public License nem hivatalos magyar fordítása. A fordítást nem a Free Software Foundation adta ki, és jogi értelemben nem határozza meg a GNU GPL-t felhasználó szoftverek terjesztési feltételeit – e tekintetben csak a GNU GPL angol nyelvű verziója irányadó. Mindazonáltal reméljük, hogy ez a fordítás segít a GNU GPL jobb megértésében.</strong></p>
				<p>
				<a href="https://web.archive.org/web/20200312185730/https://www.gnu.org/licenses/gpl.html">https://www.gnu.org/licenses/gpl.html</a>
				</p>
				<h1>
				...
				<p>Egy munka „terjesztése” olyan cselekvést jelent, amely engedély hiányában közvetlenül vagy másodlagosan felelőssé tenne az alkalmazható szerzői jogi törvények megsértéséért, kivéve közülük a számítógépen történő végrehajtást vagy egy magánpéldány módosítását. Terjesztés tehát a másolás, a szétosztás (módosítással vagy anélkül), a közzététel és egyes országokban még további tevékenységek is.
				</p>
				<p>
				...
				<p>
				A „Fő komponens” ebben a szövegkörnyezetben a végrehajtható munka futtatásához használt operációs rendszer (ha van ilyen) egy fő, lényegi komponensét (kernel, ablakkezelő rendszer és hasonlók), a munka létrehozásához használt fordítót, vagy a futtatásához használt tárgykód-értelmezőt jelenti.
				</p>
				<p>
				...
				<p>
				Ha szükséges, meg kell szerezni a munkáltatótól (ha a szerző programozóként dolgozik) vagy az iskolától a program szerzői jogairól való lemondás igazolását. További információ ezzel kapcsolatban, illetve arról, hogyan lehet alkalmazni és betartani a GNU GPL-t, a &lt;https://www.gnu.org/licenses/&gt; címen olvasható.
				</p>
				<p>
				A GNU General Public License nem engedi meg, hogy a program része legyen szellemi tulajdont képező programoknak. Ha a program egy szubrutinkönyvtár, akkor megfontolhatja, hogy nem célszerűbb-e megengedni, hogy szellemi tulajdont képező alkalmazásokkal is összefűzhető legyen a programkönyvtár. Ha ezt szeretné, akkor a GPL helyett a GNU LGPL-t kell használni. Először azonban kérjük, olvassa el a &lt;https://www.gnu.org/philosophy/why-not-lgpl.html&gt; dokumentumot.
				</p>
			</div>
		</div>
        </div>    
